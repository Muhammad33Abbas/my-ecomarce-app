...
const Footer = () => {
  ...
  return (
    ...
    <Box sx={{ marginTop:'500px', display:'flex', alignItems:'center', justifyContent:'center', flexWrap:'wrap' ,padding:4, color:'white', bgcolor:'black' }}>
         ...
         <Grid size={{md:3, xs : 12}}   border={"1px solid black"}>
          <Typography sx={{fontSize:'21px'}}>Download App</Typography>
            ...
            <Grid container> 
                ...
                <Grid size= {{md:4, xs:6}}>
                     <Box sx={{paddingLeft:'5px'}} component={'img'} src='./public/Icons/Qrcode 1.svg'></Box>
                     </Grid>
                <Grid size={{md:7, xs:6}} >
                    <Box  border={''}>
                    <Box component={'img'} src = './public/Icons/AppStore.svg'></Box>
                    <Box component={'img'} src = './public/Icons/GooglePlay.svg'></Box>
                    </Box>
